...
describe('Danmaku behavior', function() {
  ...
  it('should sync timeline with media (canvas engine)', function(done) {
    ...
    setTimeout(function() {
      assert.equal(3, danmaku.runningList.length);
    }, 350);
    setTimeout(function() {
      $video.pause();
      done();
